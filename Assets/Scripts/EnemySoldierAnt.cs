...
public class EnemySoldierAnt : MonoBehaviour
{
    public float speed;
    ...
    public bool FireDetect()
    {
        ...
        float furthestDist = 7.428f; //x starting point of player ants
    ...
    void Update()
    {
        ...
        {
            Destroy(gameObject);
            Instantiate(rocket, gameObject.transform.position, Quaternion.Euler(0,0,180));
